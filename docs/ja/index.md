...
hero:
  ...
  tagline: 厳選されたウィンドウユーティリティで作業効率を向上
  image:
    src: /home_page/home_page.png
    alt: Quick Utilities Suite ロゴ
  actions:
    - theme: brand
...
features:
  ...
  - title: Quick WindowInspector
    details: あらゆるウィンドウの詳細情報を瞬時に取得 — デバッグと開発をより効率的に。
    icon:
