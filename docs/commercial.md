...
[Compare Editions](/pricing){.vp-button.brand}
[Explore Quick BrightnessSync](/products/quick-brightnesssync){.vp-button.alt}
[Explore Quick AlwaysOnTop](/products/quick-alwaysontop){.vp-button.alt}
