...
hero:
  ...
  tagline: Ausgewählte Fenster-Hilfsprogramme für einen effizienteren Arbeitsablauf
  image:
  ...
  actions:
    ...
    - theme: alt
      text: Feedback & Probleme
      link: https://github.com/XMuli/QuickUtilitiesSuite/issues

features:
  - title: Quick BrightnessSync 🔥
    details: Echte Hardware-Helligkeitssynchronisation mit einem Klick für mehrere Monitore (DDC/CI). Verabschieden Sie sich von der Einzelanpassung der Displays.
    icon:
  ...
  - title: Quick ColorPicker
    details: Präzise Farbauswahl von jedem Bildschirmbereich mit Ausgabe in mehreren Formaten.
    icon:
      light: /images/home_features/QuickColorPicker.svg
      dark:  /images/home_features/QuickColorPicker.svg
  - title: Quick BulkFileCopy
    details: Hochgeschwindigkeitskopie großer Mengen kleiner Dateien — um ein Vielfaches schneller als das Betriebssystem.
    icon:
  ...
  - title: Quick BulkFileDelete
    details: Blitzschnelles Löschen riesiger Ordner — sparen Sie wertvolle Zeit.
    icon:
      light: /images/home_features/QuickBulkFileDelete.svg
      dark: /images/home_features/QuickBulkFileDelete.svg
  - title: Quick SnapOCR
    details: Screenshot-OCR mit einem Klick — Text aus Bildern, Webseiten oder Dokumenten sofort extrahieren und kopieren.
    icon:
      light: /images/home_features/QuickSnapOCR.svg
      dark:  /images/home_features/QuickSnapOCR.svg
  - title: Quick SnapTranslate
    details: Screenshot, OCR und Übersetzung mit einem Klick — mühelos sprachübergreifend arbeiten.
    icon:
  ...
  - title: Quick WindowInspector
    details: Fensterdetails sofort einsehen — effizienter debuggen und entwickeln.
    icon:
  ...
  - title: Quick AlwaysOnTop
    details: Jedes wichtige Fenster mit einem Klick im Vordergrund fixieren — Multitasking leicht gemacht.
    icon:
      light: /images/home_features/QuickAlwaysOnTop.svg
      dark: /images/home_features/QuickAlwaysOnTop.svg
  - title: Quick DefenderToggle
    details: Systemschutz schnell ein- oder ausschalten — erweiterte Operationen einfach gemacht.
    icon:
