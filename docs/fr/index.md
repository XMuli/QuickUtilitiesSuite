...
hero:
  ...
  tagline: Des utilitaires Windows soigneusement sélectionnés pour optimiser votre flux de travail
  image:
  ...
  actions:
    ...
    - theme: alt
      text: Commentaires et problèmes
...
features:
  ...
  - title: Quick BulkFileCopy
    details: Copie à grande vitesse d'un grand nombre de petits fichiers — plusieurs fois plus rapide que le système d'exploitation.
    icon:
  ...
  - title: Quick BulkFileDelete
    details: Suppression ultra-rapide de dossiers volumineux — économisez un temps précieux.
    icon:
      light: /images/home_features/QuickBulkFileDelete.svg
      dark: /images/home_features/QuickBulkFileDelete.svg
  - title: Quick SnapOCR
    details: OCR par capture d'écran en un clic — extrayez et copiez instantanément le texte depuis des images, pages web ou documents.
    icon:
      light: /images/home_features/QuickSnapOCR.svg
      dark:  /images/home_features/QuickSnapOCR.svg
  - title: Quick SnapTranslate
    details: Capture d'écran, OCR et traduction en un clic — travaillez sans effort dans plusieurs langues.
    icon:
  ...
  - title: Quick WindowInspector
    details: Inspectez instantanément les détails de n'importe quelle fenêtre — déboguez et développez plus efficacement.
    icon:
  ...
  - title: Quick AlwaysOnTop
    details: Épinglez n'importe quelle fenêtre importante au premier plan en un clic — multitâche en toute simplicité.
    icon:
      light: /images/home_features/QuickAlwaysOnTop.svg
      dark: /images/home_features/QuickAlwaysOnTop.svg
  - title: Quick DefenderToggle
    details: Activez ou désactivez rapidement la protection système — opérations avancées simplifiées.
    icon:
