...
hero:
  ...
  tagline: Utilitarios de janela selecionados para otimizar seu fluxo de trabalho
  image:
  ...
  actions:
    ...
    - theme: alt
      text: Feedback e Problemas
      link: https://github.com/XMuli/QuickUtilitiesSuite/issues

features:
  - title: Quick ColorPicker
    details: Capture cores precisas de qualquer lugar da tela com saida em multiplos formatos.
    icon:
      light: /images/home_features/QuickColorPicker.svg
      dark:  /images/home_features/QuickColorPicker.svg
  - title: Quick BulkFileCopy
    details: Copia em alta velocidade de grandes quantidades de arquivos pequenos — varias vezes mais rapido que o sistema operacional.
    icon:
  ...
  - title: Quick BulkFileDelete
    details: Exclusao ultrarapida de pastas enormes — economize tempo precioso.
    icon:
      light: /images/home_features/QuickBulkFileDelete.svg
      dark: /images/home_features/QuickBulkFileDelete.svg
  - title: Quick SnapOCR
    details: OCR de captura de tela com um clique — extraia e copie texto de imagens, paginas web ou documentos instantaneamente.
    icon:
      light: /images/home_features/QuickSnapOCR.svg
      dark:  /images/home_features/QuickSnapOCR.svg
  - title: Quick SnapTranslate
    details: Captura de tela, OCR e traducao com um clique — trabalhe entre idiomas sem esforco.
    icon:
  ...
  - title: Quick WindowInspector
    details: Inspecione detalhes de qualquer janela instantaneamente — depure e desenvolva com mais eficiencia.
    icon:
  ...
  - title: Quick AlwaysOnTop
    details: Fixe qualquer janela importante no topo com um clique — multitarefa facilitada.
    icon:
      light: /images/home_features/QuickAlwaysOnTop.svg
      dark: /images/home_features/QuickAlwaysOnTop.svg
  - title: Quick DefenderToggle
    details: Ative ou desative rapidamente a protecao do sistema — operacoes avancadas simplificadas.
    icon:
