...
hero:
  ...
  tagline: Utilità per finestre selezionate per ottimizzare il tuo flusso di lavoro
  image:
  ...
  actions:
    ...
    - theme: alt
      text: Feedback e Problemi
      link: https://github.com/XMuli/QuickUtilitiesSuite/issues

features:
  - title: Quick ColorPicker
    details: Cattura colori precisi da qualsiasi punto dello schermo con output in più formati.
    icon:
      light: /images/home_features/QuickColorPicker.svg
      dark:  /images/home_features/QuickColorPicker.svg
  - title: Quick BulkFileCopy
    details: Copia ad alta velocità di grandi quantità di file piccoli — diverse volte più veloce del sistema operativo.
    icon:
  ...
  - title: Quick BulkFileDelete
    details: Eliminazione fulminea di cartelle enormi — risparmia tempo prezioso.
    icon:
      light: /images/home_features/QuickBulkFileDelete.svg
      dark: /images/home_features/QuickBulkFileDelete.svg
  - title: Quick SnapOCR
    details: OCR da screenshot con un clic — estrai e copia istantaneamente testo da immagini, pagine web o documenti.
    icon:
      light: /images/home_features/QuickSnapOCR.svg
      dark:  /images/home_features/QuickSnapOCR.svg
  - title: Quick SnapTranslate
    details: Screenshot, OCR e traduzione con un clic — lavora tra lingue diverse senza sforzo.
    icon:
  ...
  - title: Quick WindowInspector
    details: Ispeziona i dettagli di qualsiasi finestra istantaneamente — debug e sviluppo più efficienti.
    icon:
  ...
  - title: Quick AlwaysOnTop
    details: Fissa qualsiasi finestra importante in primo piano con un clic — multitasking senza sforzo.
    icon:
      light: /images/home_features/QuickAlwaysOnTop.svg
      dark: /images/home_features/QuickAlwaysOnTop.svg
  - title: Quick DefenderToggle
    details: Attiva o disattiva rapidamente la protezione del sistema — operazioni avanzate semplificate.
    icon:
