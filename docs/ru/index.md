...
hero:
  ...
  tagline: Набор утилит для окон, повышающих вашу продуктивность
  image:
...
features:
  - title: Quick BrightnessSync 🔥
    details: Аппаратная синхронизация яркости одним кликом для нескольких мониторов (DDC/CI). Попрощайтесь с ручной настройкой каждого дисплея.
    icon:
  ...
  - title: Quick ColorPicker
    details: Точный захват цвета с любой точки экрана с выводом в нескольких форматах.
    icon:
      light: /images/home_features/QuickColorPicker.svg
      dark:  /images/home_features/QuickColorPicker.svg
  - title: Quick BulkFileCopy
    details: Высокоскоростное копирование большого количества мелких файлов — в разы быстрее системных средств.
    icon:
  ...
  - title: Quick BulkFileDelete
    details: Молниеносное удаление огромных папок — экономьте драгоценное время.
    icon:
      light: /images/home_features/QuickBulkFileDelete.svg
      dark: /images/home_features/QuickBulkFileDelete.svg
  - title: Quick SnapOCR
    details: OCR снимка экрана одним кликом — мгновенно извлекайте и копируйте текст из изображений, веб-страниц и документов.
    icon:
      light: /images/home_features/QuickSnapOCR.svg
      dark:  /images/home_features/QuickSnapOCR.svg
  - title: Quick SnapTranslate
    details: Снимок экрана, OCR и перевод одним кликом — работайте на разных языках без усилий.
    icon:
  ...
  - title: Quick WindowInspector
    details: Мгновенный просмотр деталей любого окна — отладка и разработка эффективнее.
    icon:
  ...
  - title: Quick AlwaysOnTop
    details: Закрепите любое важное окно поверх всех одним кликом — многозадачность без усилий.
    icon:
      light: /images/home_features/QuickAlwaysOnTop.svg
      dark: /images/home_features/QuickAlwaysOnTop.svg
  - title: Quick DefenderToggle
    details: Быстрое включение и отключение защиты системы — расширенные операции стали простыми.
    icon:
