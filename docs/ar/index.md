...
hero:
  ...
  tagline: أدوات نوافذ مختارة لتعزيز سير عملك
  image:
...
features:
  ...
  - title: Quick BulkFileDelete
    details: حذف فائق السرعة للمجلدات الضخمة — وفر وقتك الثمين.
    icon:
      light: /images/home_features/QuickBulkFileDelete.svg
      dark: /images/home_features/QuickBulkFileDelete.svg
  - title: Quick SnapOCR
    details: التعرف الضوئي على النصوص بلقطة شاشة بنقرة واحدة — استخراج ونسخ النص من الصور وصفحات الويب والمستندات فوراً.
    icon:
      light: /images/home_features/QuickSnapOCR.svg
      dark:  /images/home_features/QuickSnapOCR.svg
  - title: Quick SnapTranslate
    details: لقطة شاشة والتعرف على النص وترجمته بنقرة واحدة — اعمل عبر اللغات بسهولة.
    icon:
  ...
  - title: Quick WindowInspector
    details: فحص تفاصيل أي نافذة فوراً — تصحيح الأخطاء والتطوير بكفاءة أعلى.
    icon:
  ...
  - title: Quick AlwaysOnTop
    details: تثبيت أي نافذة مهمة في المقدمة بنقرة واحدة — تعدد المهام بسهولة.
    icon:
      light: /images/home_features/QuickAlwaysOnTop.svg
      dark: /images/home_features/QuickAlwaysOnTop.svg
  - title: Quick DefenderToggle
    details: تفعيل أو تعطيل حماية النظام بسرعة — العمليات المتقدمة أصبحت بسيطة.
    icon:
