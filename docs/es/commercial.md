...
[Compare Editions](/es/pricing){.vp-button.brand}
[Explore Quick BrightnessSync](/es/products/quick-brightnesssync){.vp-button.alt}
[Explore Quick AlwaysOnTop](/es/products/quick-alwaysontop){.vp-button.alt}
