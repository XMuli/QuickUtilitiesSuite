...
hero:
  ...
  tagline: Utilidades de ventana seleccionadas para optimizar tu flujo de trabajo
  image:
  ...
  actions:
    ...
    - theme: alt
      text: Comentarios y problemas
      link: https://github.com/XMuli/QuickUtilitiesSuite/issues

features:
  - title: Quick ColorPicker
    details: Captura con precisión cualquier color en pantalla con múltiples formatos de salida.
    icon:
      light: /images/home_features/QuickColorPicker.svg
      dark:  /images/home_features/QuickColorPicker.svg
  - title: Quick BulkFileCopy
    details: Copia a alta velocidad grandes cantidades de archivos pequeños, varias veces más rápido que el sistema operativo.
    icon:
  ...
  - title: Quick BulkFileDelete
    details: Eliminación ultrarrápida de carpetas enormes para ahorrar tiempo valioso.
    icon:
      light: /images/home_features/QuickBulkFileDelete.svg
      dark: /images/home_features/QuickBulkFileDelete.svg
  - title: Quick SnapOCR
    details: OCR de capturas de pantalla con un clic — extrae y copia texto de imágenes, páginas web o documentos al instante.
    icon:
      light: /images/home_features/QuickSnapOCR.svg
      dark:  /images/home_features/QuickSnapOCR.svg
  - title: Quick SnapTranslate
    details: Captura, OCR y traducción con un clic — trabaja en varios idiomas sin esfuerzo.
    icon:
  ...
  - title: Quick WindowInspector
    details: Inspecciona los detalles de cualquier ventana al instante — depura y desarrolla con mayor eficiencia.
    icon:
  ...
  - title: Quick AlwaysOnTop
    details: Fija cualquier ventana importante en primer plano con un clic — multitarea con facilidad.
    icon:
      light: /images/home_features/QuickAlwaysOnTop.svg
      dark: /images/home_features/QuickAlwaysOnTop.svg
  - title: Quick DefenderToggle
    details: Activa o desactiva rápidamente la protección del sistema — operaciones avanzadas simplificadas.
    icon:
